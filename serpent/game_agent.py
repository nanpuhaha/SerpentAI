...
class GameAgent(offshoot.Pluggable):
    ...
    def __init__(self, **kwargs):
        ...
        self.config = config.get(f"{self.__class__.__name__}Plugin") or {}
    ...
    def on_record_pause(self, **kwargs):
        ...
        for item in data:
            if isinstance(item, GameFrameBuffer):
                ...
                observations[timestamp] = [item, {}, list(active_keys), [], reward_score]
        ...
        with h5py.File("datasets/input_recording.h5", "a") as f:
            ...
            clear_terminal()
            print("Writing Frame/Input Data to 'datasets/input_recording.h5'... DONE")
