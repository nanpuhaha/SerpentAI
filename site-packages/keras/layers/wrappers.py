...
class Bidirectional(Wrapper):
    ...
    def __init__(self, layer, merge_mode='concat', weights=None, **kwargs):
        ...
        self.forward_layer.name = f'forward_{self.forward_layer.name}'
        self.backward_layer.name = f'backward_{self.backward_layer.name}'
    ...
    def compute_mask(self, input, mask):
        if self.return_sequences:
            return mask if self.merge_mode else [mask, mask]
        else:
            return None
    ...
    def constraints(self):
        ...
        if hasattr(self.forward_layer, 'constraints'):
            constraints |= self.forward_layer.constraints
