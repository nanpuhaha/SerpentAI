        ...
        if isinstance(model.optimizer, optimizers.TFOptimizer):
            ...
            if symbolic_weights:
                ...
                for i, (w, val) in enumerate(zip(symbolic_weights, weight_values)):
                    name = str(w.name) if hasattr(w, 'name') and w.name else f'param_{str(i)}'
    ...
    def deserialize(obj):
        ...
        if isinstance(obj, dict):
            ...
            for key, value in obj.items():
                deserialized[key] = custom_objects[value] if value in custom_objects else value
            return deserialized
        return custom_objects[obj] if obj in custom_objects else obj
...
class Sequential(Model):
    ...
    def add(self, layer):
        ...
        if not self.outputs:
            ...
            if len(layer.inbound_nodes) == 0:
                ...
                input_dtype = layer.input_dtype if hasattr(layer, 'input_dtype') else None
    ...
    def build(self, input_shape=None):
        ...
        self.model = Model(self.inputs, self.outputs[0], name=f'{self.name}_model')
    ...
    def trainable_weights(self):
        return self._gather_list_attr('trainable_weights') if self.trainable else []
